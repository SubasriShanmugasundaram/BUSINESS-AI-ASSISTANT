...
export const CustomersIcon = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ProductsIcon = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ReportsIcon = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const CurrencyIcon = ({ size = 20, className = '' }) => (
  <span style={{ fontSize: size, fontWeight: 700, lineHeight: 1 }} className={className}>₹</span>
);

export const TrendUpIcon = ({ size = 14, className = '' }) => (
...
export const InventoryIcon = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="m16.5 9.4 4.5-2.8L12 2 3 6.6l4.5 2.8" />
    <path d="M3 13.1 7.5 16 12 13.2l4.5 2.8 4.5-2.9" />
    <path d="M3 7.6v8.8l9 5.6 9-5.6V7.6" />
    <path d="M12 22V12" />
  </svg>
);
...
export const GstIcon = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
